...
public class Main {
    ...
    public static void battleshipGame() {
        ...
        int totalBattleships = initializeUserBoard(userBoard, userGuessBoard, battleships, n, m);
        ...
        while(true) {
            ...
            userAttackComputer(userGuessBoard, compBoard, battleshipState, n, m);
            ...
            computerAttackUser(userBoard, compGuessBoard, battleshipState, n, m);
     ...
     * @param compGuessBoard - computer's guessing board
     * @param battleshipState - an array of the amount of the battleship available to each player.
     * @param n - rows
     * @param m - cols
     */
    public static void computerAttackUser(String[][] userBoard, String[][] compGuessBoard,
     ...
     * @param compBoard - computer game board
     * @param battleshipState - An array of the amount of the battleship available to each player.
     * @param n - rows
     * @param m - cols
     */
    public static void userAttackComputer(String[][] userGuessBoard, String[][] compBoard,
                                          int[] battleshipState, int n, int m) {
        ...
        for (String s : battleships) {
            ...
            for (int i = 0; i < numCurrentBattleship; i++) {
                ...
                do {
                    ...
                    putBattleshipInBoard(compBoard, rowBattleship, colBattleship, orientation, currentSizeBattleship);
     ...
     * @param rowBattleship - row tile
     * @param colBattleship - col tile
     * @param orientation
     * @param currentSizeBattleship
     */

    public static void putBattleshipInBoard(String[][] board,int rowBattleship,
                                            int colBattleship,int orientation, int currentSizeBattleship){
        int HORIZONTAL = 0;
    ...
    public static boolean checkBoardBoundaries(int n, int m, int sizeBattleship, int rowBattleship,
                                               int colBattleship, int orientation) {
        int HORIZONTAL = 0;
        /** check for horizontal ship */
        if (orientation == HORIZONTAL) {
     ...
     * @param curRow - row coordinate
     * @param curCol - col coordinate
     * @param minRow - row min limit
     * @param minCol - col min limit
     * @param maxRow - row max limit
     * @param maxCol - col max limit
     * @return True if
     */

    public static boolean outOfBound(int curRow, int curCol, int minRow, int minCol, int maxRow, int maxCol){
